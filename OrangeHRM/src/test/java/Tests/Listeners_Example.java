...
import Listeners.Vidhya;
import Pages.LoginPage;

public class Listeners_Example extends BaseOrCommonClass {
	...
	public void launchURL() throws IOException {
		...
		vi.beforeNavigateTo("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login", driver);

		urlLaunching("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login");
		
		vi.afterNavigateTo("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login", driver);
