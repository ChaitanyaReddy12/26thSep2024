...
public class ExtentReportExample2 extends BaseOrCommonClass {
	...
	public void startTest() {
		...
		report = new ExtentReports(System.getProperty("user.dir") + "\\Saritha.html");

		test = report.startTest("Shyam Class");
	}
