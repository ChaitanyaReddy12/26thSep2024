...
public class Attribute_Description extends BaseOrCommonClass {
	...
	@Test (priority = 1, timeOut = 7000, description = "this method is used to enter username in the login page")
